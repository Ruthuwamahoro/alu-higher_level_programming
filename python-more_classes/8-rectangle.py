#!/usr/bin/python3
"""Defines and represent only rectangle class."""


class Rectangle:
    """creating a rectangle as a class"""
    ...
    @property
    def width(self):
        """Getting the value of the width of the Rectangle."""
        return self.__width
    ...
    def area(self):
        """calculating and returning the value of the area of the Rectangle."""
